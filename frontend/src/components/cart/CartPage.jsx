...
const CartPage = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast("Product added to the cart succesfully");
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-20">
        ...
        <div>
          ...
          <div className="flex items-center">
            <p>
              {" "}
              'This product is designed with attention to detail, ensuring both
              style and comfort.', 'Perfect for your daily needs, this product
              offers unmatched quality and durability.', 'Made from premium
              materials, this product is guaranteed to last and impress.' 'This
              product is designed with attention to detail, ensuring both style
              and comfort.', 'Perfect for your daily needs, this product offers
              unmatched quality and durability.', 'Made from premium materials,
              this product is guaranteed to last and impress.' 'This product is
              designed with attention to detail, ensuring both style and
              comfort.', 'Perfect for your daily needs, this product offers
              unmatched quality and durability.', 'Made from premium materials,
              this product is guaranteed to last and impress.'
            </p>
          </div>

...
const EnjoyAble = () => {
  return (
    <section className="flex flex-col md:flex-row items-start gap-10 p-12 my-24 bg-medium-color w-[95%] mx-auto rounded-2xl">
      ...
      <div className="flex-1 flex flex-col items-start mt:6 md:mt-14 ">
        ...
        <h2 className="text-4xl text-dark-color font-bold mt-5">
          Joyful Learning Engine
        </h2>
        <p className="text-white text-xl mt-5">
          Kids' e-commerce solutions use smart tech to enhance shopping—offering
          personalized recommendations, inventory tools, and data-driven
          insights. From playful UX to seamless checkout, we simplify every
          parent’s buying journey.
        </p>
      </div>
    </section>
  );
